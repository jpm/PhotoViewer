...
- (void)emailPhoto{
	...
	[mailViewController addAttachmentData:[NSData dataWithData:UIImagePNGRepresentation(((EGOPhotoImageView*)[self.photoViews objectAtIndex:pageIndex]).imageView.image)] mimeType:@"image/png" fileName:@"Photo.png"];
